...
public class fileterlianxi{
    ...
    private static void map(){
        ...
        JavaRDD<Integer> multipleNumberRDD=numberRDD.filter(new Function <Integer, java.lang.Boolean>() {
            @Override
            public java.lang.Boolean call(Integer v1) throws Exception {
                return v1 % 2== 0;
            }
        });
        //打印新的RDD
